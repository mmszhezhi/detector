...
class CropIwaImageView extends androidx.appcompat.widget.AppCompatImageView implements OnNewBoundsListener, ConfigChangeListener {
    ...
    public void notifyImagePositioned() {
        if (imagePositionedListener != null) {
            ...
            imagePositionedListener.onImagePositioned(imageRect, imageCropRect, getImageRect(), drawable == null ? null : drawable.getBitmap());
        }
    }
    ...
    public void setImageCropRect(RectF imageCropRect) {
