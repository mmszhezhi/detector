...
public class CropIwaView extends FrameLayout {
    ...
    protected CropIwaOverlayView overlayView;
    ...
    private CropIwaBitmapManager.BitmapLoadListener bitmapLoadListener;
    ...
    public void setImageViewBackgroundColor(int color) {
        imageView.setBackgroundColor(color);
    }

    public void setImageCropRect(RectF rect) {
        imageView.setImageCropRect(rect);
    }
    ...
    public void setImageUri(Uri uri, CropIwaBitmapManager.BitmapLoadListener listener) {
    ...
    public Rect getCropRect() {
        ...
        return cropArea.getCropRect(drawable.getBitmap());
    }

    public void setCropRect(Rect rect) {
        overlayView.setCropRect(rect);
    }
    ...
    private class BitmapLoadListener implements CropIwaBitmapManager.BitmapLoadListener {
        ...
        public void onBitmapLoaded(Uri imageUri, Bitmap bitmap) {
            ...
            if (bitmapLoadListener != null) {
                bitmapLoadListener.onBitmapLoaded(imageUri, bitmap);
            }
        }
        ...
        public void onLoadFailed(Throwable e) {
            ...
            if (bitmapLoadListener != null) {
                bitmapLoadListener.onLoadFailed(e);
            }
        }
    }
