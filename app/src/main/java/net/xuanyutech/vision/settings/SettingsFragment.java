...
public class SettingsFragment extends PreferenceFragmentCompat {
  ...
  private void setupModelPreference() {
    Preference modelPreference = findPreference(getString(R.string.pref_key_pref_model));
    if (modelPreference == null)
      return;
    modelPreference.setSummaryProvider(preference -> preference.getSharedPreferences().getString(getString(R.string.pref_key_pref_model), getString(R.string.default_value)));
  }
