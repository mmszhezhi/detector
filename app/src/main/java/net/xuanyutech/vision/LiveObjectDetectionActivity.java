...
import net.xuanyutech.vision.camera.CameraSource;
import net.xuanyutech.vision.camera.CameraSourcePreview;
import net.xuanyutech.vision.camera.GraphicOverlay;
import net.xuanyutech.vision.camera.WorkflowModel;
import net.xuanyutech.vision.camera.WorkflowModel.WorkflowState;
import net.xuanyutech.vision.objectdetection.ProminentObjectProcessor;
import net.xuanyutech.vision.search.BottomSheetScrimView;
import net.xuanyutech.vision.search.Product;
import net.xuanyutech.vision.search.ProductAdapter;
import net.xuanyutech.vision.search.SearchEngine;
import net.xuanyutech.vision.search.SearchedObject;
import net.xuanyutech.vision.settings.SettingsActivity;
    ...
    workflowModel.searchedObject.observe(
        ...
        searchedObject -> {
          if (searchedObject != null) {
            ...
            if (productList != null) {
              bottomSheetTitleView.setText(getResources().getQuantityString(R.plurals.bottom_sheet_title, productList.size(), productList.size()));
              productRecyclerView.setAdapter(new ProductAdapter(productList));
            } else {
              productRecyclerView.setAdapter(null);
            }
            if (!searchedObject.getErrorMsg().isEmpty()) {
              bottomSheetTitleView.setText(searchedObject.getErrorMsg());
            }
