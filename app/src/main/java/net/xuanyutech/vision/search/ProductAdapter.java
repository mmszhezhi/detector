  ...
  static class ProductViewHolder extends RecyclerView.ViewHolder {
    ...
    void bindProduct(Product product) {
      ...
      if (!TextUtils.isEmpty(product.imageUrl)) {
        Picasso.get().load(product.imageUrl).placeholder(R.drawable.ic_baseline_photo_size_select_actual_24).into(imageView);
      } else {
        imageView.setImageDrawable(imageView.getResources().getDrawable(R.drawable.ic_baseline_photo_size_select_actual_24));
      }
