...
public class ObjectConfirmationGraphic extends GraphicOverlay.Graphic {
  ...
  ObjectConfirmationGraphic(
    ...
    progressRingStrokePaint.setColor(ContextCompat.getColor(context, android.R.color.white));
    ...
    innerRingPaint.setColor(ContextCompat.getColor(context, android.R.color.white));
