...
package net.xuanyutech.vision.camera;
...
import net.xuanyutech.vision.search.SearchEngine.SearchResultListener;
...
public class WorkflowModel extends AndroidViewModel implements SearchResultListener {
  ...
  @Override
  public void onSearchCompleted(DetectedObject object, List<Product> products, String errMsg) {
    ...
    new Handler(getContext().getMainLooper()).post(() -> {
        ...
        searchedObject.setValue(
                new SearchedObject(getContext().getResources(), confirmedObject, products, errMsg));
    });
//    searchedObject.setValue(
